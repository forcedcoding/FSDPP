...
//         const API_KEY = "AIzaSyD2gk5wD5SxW9nVKwSg-gmRhJ1tIzqXZtE";
//         const query = "technology"; // Change this to your search term
//         const url = `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${query}&type=video&key=${API_KEY}`;
//         async function fetchVideos() {
//         try {
//             const response = await fetch(url);
//             const data = await response.json();
//             console.log(data); // Log the video data
...
//                     <iframe width="100%" height="120" src="https://www.youtube.com/embed/${videoId}" frameborder="0" allowfullscreen></iframe>;
//                     <h4>${title}</h4>`;
